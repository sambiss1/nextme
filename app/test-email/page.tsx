  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Test d&apos;envoi d&apos;email</h1>
        ...
        {result && (
          ...
          >
            <div className="flex items-start gap-3">
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 ${result.success ? 'bg-green-500' : 'bg-red-500'
                  }`}
              >
                {result.success ? (
                  <svg
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Assurez-vous d&apos;avoir configuré les variables d&apos;environnement suivantes dans votre fichier <code className="bg-gray-200 px-1 rounded">.env.local</code> :
          </p>
