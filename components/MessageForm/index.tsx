...
export default function MessageForm({ onSubmit, onSuccess }: MessageFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onSuccess?.();
      toast.success('Message programmé. Rendez-vous dans le futur.', {
        duration: 2000,
      });
    } finally {
      ...
      <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="space-y-3">
          ...
          <textarea
            ...
            required
            rows={16}
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#56ccf2] focus:border-[#56ccf2] transition-all resize-none text-base leading-relaxed bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            {dateOption === 'custom' && (
              <input
                ...
                required
                min={minDateString}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#56ccf2] focus:border-[#56ccf2] transition-all text-base bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
              />
            )}
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <label className="flex items-center gap-2 cursor-pointer bg-gray-50 dark:bg-gray-800 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 hover:border-[#56ccf2] transition-all flex-1">
                <input
                  type="radio"
                  name="visibility"
                  value="private"
                ...
                />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Privé</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer bg-gray-50 dark:bg-gray-800 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 hover:border-[#f2c94c] transition-all flex-1">
                <input
                  type="radio"
                  name="visibility"
                  value="public"
          ...
          <input
            ...
            multiple
            accept="image/*,.pdf"
            className="w-full px-3 py-2 border border-dashed border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#56ccf2] focus:border-[#56ccf2] transition-all text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 file:mr-3 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-[#56ccf2] file:text-white hover:file:bg-[#45b8e0] file:cursor-pointer"
          />
